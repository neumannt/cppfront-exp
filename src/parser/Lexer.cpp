...
static const unordered_map<string_view, Lexer::Keyword> keywords{
    ...
    // Soft keywords
    {"pre"sv, Lexer::Keyword::Pre}, {"post"sv, Lexer::Keyword::Post}, {"assert"sv, Lexer::Keyword::Assert}, {"in"sv, Lexer::Keyword::In}, {"copy"sv, Lexer::Keyword::Copy}, {"inout"sv, Lexer::Keyword::Inout}, {"out"sv, Lexer::Keyword::Out}, {"move"sv, Lexer::Keyword::Move}, {"forward"sv, Lexer::Keyword::Forward}
};
//---------------------------------------------------------------------------
