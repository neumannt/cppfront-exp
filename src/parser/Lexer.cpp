...
// Handle an identifier
{
    ...
    if (auto iter = alternativeTokens.find(i); iter != alternativeTokens.end()) {
        switch (iter->second) {
            ...
            case AltToken::Xor: return Token::Caret;
            ...
            case AltToken::Xor_eq: return Token::CaretEq;
    ...
    while (true) {
        ...
        switch (c1) {
            ...
            case '<':
                ...
                return Token::Less;
            case '>':
                if ((c2 == '>') && (c3 == '=')) return multiByte(2, Token::RightShiftEq);
            ...
            case '%':
                ...
                return Token::Modulo;
            case '^':
                if (c2 == '=') return multiByte(1, Token::CaretEq);
                return Token::Caret;
            case '~':
